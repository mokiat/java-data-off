...
public class OffLoaderFaceColorRGBTest extends OffLoaderBaseTest {

    @Override
    protected String getResourceName() {
        return "valid_face_color_rgb.off";
    }
    ...
    public void testLoadFaceColor() throws Exception {
        ...
        assertFaceColorEquals(1.0f, 0.5f, 0.0f, 1.0f, object.getFaces().get(0));
